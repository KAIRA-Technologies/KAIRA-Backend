...
import { verifyToken } from './middleware/auth.js'; // ← NEW
...
/* -------------------- AUTH (Public) -------------------- */
// Login / Signup / Forgot-password are intentionally unprotected
...
app.post('/api/whatsapp/send', async (req, res) => {
  ...
  const TEMPLATE_NAME = process.env.MSGCLUB_TEMPLATE_NAME;
